...
urlpatterns = [
    ...
    url(r'^thumb/(?P<pk>[0-9]+)/$', viewPhotoseries.as_view(), name='view_thumbseries'),
    ...
    url(r'^edit/(?P<pk>[0-9]+)/$', updatePhotoseries.as_view(), name='update_series'),
    url(r'^delete/(?P<pk>[0-9]+)/$', deletePhotoseries.as_view(), name='delete_series'),
